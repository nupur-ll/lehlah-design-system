...
export default function StatTile({ label, value, prefix }: StatTileProps) {
  return (
    <div className="flex flex-1 flex-col items-center justify-center gap-0 rounded-[var(--card-corner-radius-tile)] bg-[var(--card-tile-background)] p-1">
      <p className="w-full truncate text-center text-[length:var(--type-body-extra-small-size)] leading-[var(--type-body-extra-small-line-height)] font-semibold uppercase tracking-[1px] text-[color:var(--card-text-label)]">
        {label}
      </p>
